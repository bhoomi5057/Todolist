...
class UpdateNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val completedOld = intent.getStringExtra(COLUMN_NAME_COMPLETED)
...
if(completedOld=="true")R.drawable.baseline_check_box_24 else R.drawable.baseline_check_box_outline_blank_24
    ...
    private fun updateData() {
        ...
        if (notEmpty()) {
            ...
            dbOpenHelper.updateNote(
                ...
                etUpdatedDescription.editText?.text.toString(),"false"
            )
